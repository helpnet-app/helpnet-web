...
export default class ProgramService {
  ...
  async startProg(id_prog: string): Promise<Program> {
    const response = await fetch(
      `https://helpnet-api-1.onrender.com/programs/${id_prog}/start`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
  ...
  async finishProg(id_prog: string): Promise<Program> {
    const response = await fetch(
      `https://helpnet-api-1.onrender.com/programs/${id_prog}/finish`,
      {
        method: "POST",
        headers: {
          Accept: "application/json",
  ...
  async deleteProg(id_prog: string): Promise<Program> {
    const response = await fetch(
      `https://helpnet-api-1.onrender.com/programs/${id_prog}`,
      {
        method: "DELETE",
        headers: {
          Accept: "application/json",
  ...
  async aprooveApplication(id_application: string): Promise<Program> {
    const response = await fetch(
      `https://helpnet-api-1.onrender.com/programs/application/${id_application}/approves'`,
      {
        method: "PATCH",
        headers: {
          Accept: "application/json",
  ...
  async rejectApplication(id_application: string): Promise<Program> {
    const response = await fetch(
      `https://helpnet-api-1.onrender.com/programs/application/${id_application}/reject`,
      {
        method: "PATCH",
        headers: {
          Accept: "application/json",
